...
const Header = (props: Props) => {
  ...
  return (
    <header className='sticky top-0 p-5 flex items-start justify-between max-w-7xl mx-auto z-20 xl:items-center'>
      ...
      >
        {/* Social Icons */}
        <SocialIcon url="https://github.com/AadiRana911" fgColor='gray' bgColor='transparent' />
        <SocialIcon url="https://www.facebook.com/aadi.me.3009554892" fgColor='gray' bgColor='transparent' />
